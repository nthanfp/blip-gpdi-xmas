        ...
        <div class="space-y-3">
            ...
            <div class="card-hover flex items-start gap-4 p-4 rounded-xl bg-white border border-stone-100 shadow-sm">
                ...
                <div class="space-y-0.5">
                    ...
                    <p class="text-sm font-semibold text-stone-800">Minggu, 24 Desember 2026</p>
                </div>
            </div>
            ...
            <div class="card-hover flex items-start gap-4 p-4 rounded-xl bg-white border border-stone-100 shadow-sm">
                ...
                <div class="space-y-0.5">
                    ...
                    <p class="text-sm font-semibold text-stone-800">18:00 – 21:00 WIB</p>
                    <p class="text-xs text-stone-500">Open Gate: 17:00 WIB</p>
                </div>
            </div>
