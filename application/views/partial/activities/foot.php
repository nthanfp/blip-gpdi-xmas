        ...
        function showInstallBanner() {
            ...
            Swal.fire({
                ...
                html: '<div style="text-align:center;padding:8px 0">' +
                    ...
                    '<p style="font-size:14px;color:#6c757d;margin:0">Add INTERNAL QR TAG to your home screen for faster access</p>' +
                    '</div>',
...
<!-- Google tag (gtag.js) -->
<!-- <script async src="https://www.googletagmanager.com/gtag/js?id=G-LZS5VG1EKJ"></script>
<script>
